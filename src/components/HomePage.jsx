        ...
        <section className="h-screen flex justify-center flex-col transition-colors duration-300 section-container">
            <div className="max-w-screen-sm ">
                <h1 className="text-4xl font-bold leading-tight intro-tag">
                    Hi, I'm
                    <span className="gradient-text intro-tag"> Rahul</span>

                </h1>
                <h3 className="text-2xl font-bold my-1 designation-tag">And I'm a <span ref={el} className="text-[#00abf0]"></span></h3>
